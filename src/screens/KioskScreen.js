...
const clk = themed(() => StyleSheet.create({
  wrap: { alignItems: 'center', paddingVertical: 20 },
  time: { fontSize: 56, fontWeight: '800', color: C.shellText, letterSpacing: -1 },
  date: { fontSize: 14, color: C.shellTextMuted, marginTop: 2 },
}));
...
const cam = themed(() => StyleSheet.create({
  ...
  heading:       { fontSize: 20, fontWeight: '700', color: C.shellText, marginBottom: 20 },
  ...
  oval:          { position: 'absolute', top: '10%', left: '15%', width: '70%', height: '80%', borderRadius: 999, borderWidth: 2, borderColor: C.shellTextFaint, borderStyle: 'dashed' },
  ...
  countText:     { fontSize: 20, fontWeight: '800', color: C.shellText },
  hint:          { color: C.shellTextMuted, fontSize: 14, marginTop: 14, marginBottom: 20 },
  btnRow:        { flexDirection: 'row', gap: 12, width: '100%' },
  captureBtn:    { flex: 1, backgroundColor: C.brand, borderRadius: 14, paddingVertical: 14, alignItems: 'center' },
  captureBtnText: { color: C.onBrand, fontSize: 15, fontWeight: '700' },
  skipBtnInline: { backgroundColor: C.kioskBorder, borderRadius: 14, paddingVertical: 14, paddingHorizontal: 20, alignItems: 'center' },
  skipInlineText: { color: C.shellTextMuted, fontSize: 15, fontWeight: '600' },

  permCard:    { backgroundColor: C.shellCard, borderRadius: 24, padding: 28, alignItems: 'center', width: SW - 60 },
  permIcon:    { fontSize: 48, marginBottom: 12 },
  permTitle:   { fontSize: 20, fontWeight: '700', color: C.shellText, marginBottom: 8 },
  permSub:     { fontSize: 14, color: C.shellTextMuted, textAlign: 'center', marginBottom: 20, lineHeight: 20 },
  ...
  permBtnText: { color: C.onBrand, fontSize: 15, fontWeight: '700' },
  skipBtn:     { paddingVertical: 10 },
  skipText:    { color: C.shellTextFaint, fontSize: 14 },
}));
  ...
  return (
    <Animated.View style={[ov.wrap, { opacity, transform: [{ scale }] }]}>
      <View style={[ov.card, { borderColor: accent + '55' }]}>
        ...
        <Text style={[ov.title, { color: isError ? C.error : C.shellText }]}>{title}</Text>
...
const ov = themed(() => StyleSheet.create({
  wrap:       { position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, justifyContent: 'center', alignItems: 'center', zIndex: 100, paddingHorizontal: 24, backgroundColor: C.kioskResult },
  card:       { width: '100%', backgroundColor: C.kioskCard, borderRadius: 28, borderWidth: 1, padding: 32, alignItems: 'center', overflow: 'hidden' },
  ...
  title:      { fontSize: 30, fontWeight: '800', textAlign: 'center', marginBottom: 8, letterSpacing: -0.5, color: C.shellText },
  sub:        { fontSize: 15, color: C.shellTextMuted, textAlign: 'center', lineHeight: 22 },
...
const pm = themed(() => StyleSheet.create({
  overlay:    { flex: 1, backgroundColor: C.scrim, justifyContent: 'center', alignItems: 'center' },
  card:       { backgroundColor: C.elevated, borderRadius: 24, padding: 28, width: SW - 64, alignItems: 'center' },
  ...
  btnText:    { color: C.onBrand, fontSize: 16, fontWeight: '700' },
      ...
      {lastPunch && (
        <View style={s.lastRow}>
          ...
          <Text style={s.lastText}>
            <Text style={{ color: C.shellText, fontWeight: '700' }}>{lastPunch.name}</Text>
            {'  '}
...
const s = themed(() => StyleSheet.create({
  root:    { flex: 1, backgroundColor: C.kioskBg },

  header:       { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 20, paddingTop: 8 },
  locationPill: { flexDirection: 'row', alignItems: 'center', backgroundColor: C.shellInput, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 7 },
  dot:          { width: 7, height: 7, borderRadius: 3.5, backgroundColor: C.brand, marginRight: 7 },
  locationText: { color: C.shellText, fontSize: 13, fontWeight: '600' },
  gearBtn:      { width: 40, height: 40, borderRadius: 20, backgroundColor: C.shellInput, justifyContent: 'center', alignItems: 'center' },
  gearIcon:     { fontSize: 18, color: C.shellTextMuted },

  divider: { height: 1, backgroundColor: C.kioskCard, marginHorizontal: 24, marginBottom: 28 },

  card:       { marginHorizontal: 20, backgroundColor: C.kioskCard, borderRadius: 24, padding: 24, borderWidth: 1, borderColor: C.kioskBorder },
  cardLabel:  { fontSize: 11, color: C.shellTextFaint, textAlign: 'center', marginBottom: 18, fontWeight: '600', letterSpacing: 1 },
  input:      { backgroundColor: C.shellInput, borderRadius: 14, paddingVertical: 16, paddingHorizontal: 20, fontSize: 24, color: C.shellText, textAlign: 'center', letterSpacing: 3, marginBottom: 14, borderWidth: 1, borderColor: C.shellInputEdge },
  ...
  punchBtnOff: { backgroundColor: C.shellInput, shadowOpacity: 0, elevation: 0 },
  punchBtnText: { color: C.onBrand, fontSize: 15, fontWeight: '800', letterSpacing: 1 },

  loadingWrap: { alignItems: 'center', paddingVertical: 24 },
  loadingText: { color: C.shellTextFaint, fontSize: 14, marginTop: 12 },
  ...
  lastText: { fontSize: 13, color: C.shellTextFaint },
}));
