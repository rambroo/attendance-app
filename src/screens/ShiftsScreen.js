...
const stp = themed(() => StyleSheet.create({
  overlay:    { flex: 1, backgroundColor: C.scrimLight, justifyContent: 'flex-end' },
  sheet:      { backgroundColor: C.elevated, borderTopLeftRadius: 20, borderTopRightRadius: 20, maxHeight: '60%', padding: 20 },
...
const sa = themed(() => StyleSheet.create({
  card:         { backgroundColor: C.card, borderRadius: 12, padding: 16, marginBottom: 10, elevation: 1 },
...
const sr = themed(() => StyleSheet.create({
...
const rf = themed(() => StyleSheet.create({
  ...
  backArrow:   { fontSize: 18, color: C.heroText },
  headerTitle: { fontSize: 18, fontWeight: '700', color: C.heroText, marginLeft: 4 },
  scroll:      { flex: 1 },
  ...
  textArea:    { backgroundColor: C.card, borderRadius: 10, paddingHorizontal: 14, paddingVertical: 12, borderWidth: 1, borderColor: C.border, fontSize: 15, color: C.textPrimary, minHeight: 100 },
...
const s = themed(() => StyleSheet.create({
  ...
  newRequestText: { color: C.onBrand, fontSize: 15, fontWeight: '700' },
